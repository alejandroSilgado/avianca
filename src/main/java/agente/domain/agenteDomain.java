...
public class agenteDomain {
    public static void main(String[] args) {
        consultarAsignacionTripulacion();
    }
    ...
    public static void registrarCliente() {
        ...
        agente.Interface.dbOutAgente.dbregistrarCliente(nombre, edad, email, contraseña, tipo_documento, numeroDocumento);
    ...
    public static void actualizarCliente() {
            ...
            agente.Interface.dbOutAgente.dbActualizarCliente(idcliente, nombre, edad, email, contraseña, tipo_documento, numeroDocumento);
    ...
    public static void eliminarReserva() {
        ...
        resources.FuncionesGlobales.ImprimirTabla("reservas");
