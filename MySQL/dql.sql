...
INSERT INTO clientes (nombre, edad, email, contraseña, id_documento) VALUES
('Juan Pérez', 30, 'juan.perez@example.com', 'password123', 1),
('Ana Gómez', 25, 'ana.gomez@example.com', 'password123', 2),
('Luis Martínez', 35, 'luis.martinez@example.com', 'password123', 3);
